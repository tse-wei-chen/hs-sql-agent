          ...
          <FieldGroup class="grid gap-4 md:grid-cols-2">
            ...
            <Field>
              ...
              <Select v-model="form.sqlProvider">
                ...
                <SelectContent>
                  <SelectItem v-for="provider in PROVIDER_OPTIONS" :key="provider" :value="provider">
                    {{ provider }}
                  </SelectItem>
                </SelectContent>
              </Select>
            ...
            ">
              ...
              <Input id="password" type="password" v-model="form.password" placeholder="Database password" />
              <p v-if="editingId" class="text-[0.7rem] text-muted-foreground mt-1">
          ...
          <div v-for="db in dbs" :key="db.id"
            ...
            <div class="flex items-start justify-between mb-2">
              ...
              <div class="flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <Button variant="ghost" size="icon" class="h-8 w-8 text-destructive" @click="remove(db.id)">
                  <Trash2 class="size-4" />
                </Button>
              </div>
            </div>
