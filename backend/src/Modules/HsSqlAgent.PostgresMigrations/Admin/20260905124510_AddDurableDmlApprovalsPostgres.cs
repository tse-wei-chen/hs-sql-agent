...
[Migration("20260905124510_AddDurableDmlApprovalsPostgres")]
public sealed class AddDurableDmlApprovalsPostgres : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            constraints: table => table.PrimaryKey("PK_DmlApprovalRequests", x => x.RequestId));
    ...
    protected override void Down(MigrationBuilder migrationBuilder) =>
        migrationBuilder.DropTable(name: "DmlApprovalRequests");
}
