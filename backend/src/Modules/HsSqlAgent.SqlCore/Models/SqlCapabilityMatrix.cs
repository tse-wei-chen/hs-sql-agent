...
{
    public const string Version = "2026-08-27.50";
        ...
        SqlProviderCapabilityProfile? targetProfile = null)
    {
        ...
        var capabilities = new List<SqlCapability>
        {
            ...
            SqlJoinCapabilityRules.FullJoinMatrixCapability(provider),
