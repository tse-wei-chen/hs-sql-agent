...
global using IProviderConnectionDmlPlanningMetadataReader = HsSqlAgent.Provider.Abstractions.IProviderConnectionDmlPlanningMetadataReader;
global using DatabaseDmlPlanningMetadata = HsSqlAgent.Provider.Abstractions.DatabaseDmlPlanningMetadata;
