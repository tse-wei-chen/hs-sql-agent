...
- `sql-generated-postgres-distinct-from-compatibility-floor.json` is the PostgreSQL null-safe `IS DISTINCT FROM` / `IS NOT DISTINCT FROM` expansion floor across operand and query-context combinations.
